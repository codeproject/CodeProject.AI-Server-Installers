...
; Define some constants to make thing easier
  ...
  #define DotNetVersion "__DOTNET_VERSION__"
  #define DotNetHostingVersion "__DOTNET_HOSTING_VERSION__"
  #define SetupExeName "__SETUP_EXE_NAME__"
  #define ServerRepoRelPath "__REPO_BASE_PATH__"
#endif
...
#else
  ; .NET Hosting Bundle
  #define HostingBundleInstallerExe "dotnet-hosting-__DOTNET_HOSTING_VERSION__-win.exe"
  #define HostingBundleDownloadURL  "__HOSTING_BUNDLE_URL__"
  ; Use https://emn178.github.io/online-tools/sha256_checksum.html to calculate this:
  #define HostingBundleSHA256       "__HOSTING_BUNDLE_SHA256__"

  ; VC++ redistributable.
  #define VCRedistInstallerExe      "vc_redist.__ARCHITECTURE__.exe"
  #define VCRedistDownloadURL       "https://aka.ms/vs/17/release/vc_redist.__ARCHITECTURE__.exe"
  #define VCRedistSHA256            ""
#endif
...
ArchitecturesAllowed=__ARCHITECTURE__
...
ArchitecturesInstallIn64BitMode=__ARCHITECTURE__
